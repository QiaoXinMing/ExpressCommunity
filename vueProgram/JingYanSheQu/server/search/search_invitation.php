...
$sql = "select a.arctile_id,a.arctile_title,a.arctile_content from express_arctile_info a order by arctile_forward desc LIMIT 6";
...
while ($rows=mysqli_fetch_array($result,MYSQL_ASSOC)){
    ...
    array_push($invitationList,$rows);
}
