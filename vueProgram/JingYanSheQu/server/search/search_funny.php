...
$sql = "select p.picture_title, p.resource_url, p.picture_content, per.personal_id , per.personal_username from express_picture_info p , express_personal_info per where p.picture_nav_id ='11' order by p.picture_looked desc LIMIT 5";
