 ...
 <div class="container middle clearfix">
   <div class="arctilesDetailsLeft DetailsLeft hotTag left">
     ...
     <div class="arctileUerInfo right">
       ...
       <span><i class="fa fa-heart"></i>{{arctileDetais.arctile_forward}} 人喜欢</span> 
...
export default {
  ...
  created:function(){
     this.postArctileDetails(this.$route.query.id);
     this.arctileId = this.$route.query.id;
  },
  components: {
    DetailsRightInfo,
    comment
