	...
	<router-link tag="h3" :to="{path:'VideoDetails',query:{id:expressArctile.video_id}}" class="overflow ht">
         ...
         <div class="beautiful-article-info posrel"> 
          ...
          <div class="beautiful-article-bottom-info posabs height"> 
              ...
              <em><i class="fa fa-eye"></i>&nbsp;{{expressArctile.video_looked}}</em>
              <em><i class="fa fa fa-reply"></i>&nbsp;{{expressArctile.video_reply}}</em>
              <em><i class="fa fa-share-alt"></i>&nbsp;{{expressArctile.video_forward}}</em>
              <em><i class="fa fa-folder-open" alt="收藏"></i>&nbsp;{{expressArctile.video_collection}}</em>
...
export default {
  ...
  methods: {
    ...mapActions(["getVideoList","addMore"]),
    addMoreVideos(){
      this.addMore("videos");
    }
  },
